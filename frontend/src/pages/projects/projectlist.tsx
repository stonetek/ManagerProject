  ...
  useEffect(() => {
    ...
    return (
        <>
            ...
            <div className='w-screen h-1/6 flex justify-center items-center ml-12'>
            <div className='w-full h-1/2 grid grid-cols-3 '>
            {projects.map(proj =>(
                <div className="bg-white w-80 h-80 rounded-2xl mt-10 flex flex-col 
                items-center mr-5 hover:bg-stone-400 hover:bg-sky-200" key={proj.id}>
